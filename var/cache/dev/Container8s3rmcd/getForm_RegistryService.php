...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['AppBundle\\Form\\AccountType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\AccountType']) ? $this->services['AppBundle\\Form\\AccountType'] : ($this->services['AppBundle\\Form\\AccountType'] = new \AppBundle\Form\AccountType())) && false ?: '_'};
}, 'AppBundle\\Form\\BestellingType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\BestellingType']) ? $this->services['AppBundle\\Form\\BestellingType'] : ($this->services['AppBundle\\Form\\BestellingType'] = new \AppBundle\Form\BestellingType())) && false ?: '_'};
}, 'AppBundle\\Form\\BestelregelType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\BestelregelType']) ? $this->services['AppBundle\\Form\\BestelregelType'] : ($this->services['AppBundle\\Form\\BestelregelType'] = new \AppBundle\Form\BestelregelType())) && false ?: '_'};
}, 'AppBundle\\Form\\FruitType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\FruitType']) ? $this->services['AppBundle\\Form\\FruitType'] : ($this->services['AppBundle\\Form\\FruitType'] = new \AppBundle\Form\FruitType())) && false ?: '_'};
}, 'AppBundle\\Form\\ReceptType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\ReceptType']) ? $this->services['AppBundle\\Form\\ReceptType'] : ($this->services['AppBundle\\Form\\ReceptType'] = new \AppBundle\Form\ReceptType())) && false ?: '_'};
